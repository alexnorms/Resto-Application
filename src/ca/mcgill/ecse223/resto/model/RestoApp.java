...
public class RestoApp implements Serializable
{
  ...
  /* Code from template association_AddManyToOne */
  public LoyaltyCard addLoyaltyCard(String aContactName, String aContactEmailAddress, String aContactPhoneNumber, String aContactPostalCode)
  {
    return new LoyaltyCard(aContactName, aContactEmailAddress, aContactPhoneNumber, aContactPostalCode, this);
  }
  ...
  // line 9 "../../../../../RestoAppPersistence.ump"
   public void reinitialize(){
    ...
    LoyaltyCard.reinitializeAutouniqueLoyaltyCardNumber(this.getLoyaltyCards());
  }
