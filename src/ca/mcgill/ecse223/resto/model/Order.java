...
public class Order implements Serializable
{
  ...
  public boolean setLoyaltyCard(LoyaltyCard aLoyaltyCard)
  {
    ...
    {
      existingLoyaltyCard.removeOrder(this);
    }
    if (aLoyaltyCard != null)
    {
      aLoyaltyCard.addOrder(this);
    }
    wasSet = true;
    return wasSet;
  }
  ...
  public void delete()
  {
    ...
    if (loyaltyCard != null)
    {
      ...
      placeholderLoyaltyCard.removeOrder(this);
    }
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "loyaltyCard = "+(getLoyaltyCard()!=null?Integer.toHexString(System.identityHashCode(getLoyaltyCard())):"null") + System.getProperties().getProperty("line.separator") +
